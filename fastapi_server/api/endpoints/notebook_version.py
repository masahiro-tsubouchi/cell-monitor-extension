...
async def create_notebook_snapshot(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to create notebook snapshot: {str(e)}"
        )
...
async def commit_notebook_version(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to commit notebook version: {str(e)}"
        )
...
async def commit_notebook_direct(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to commit notebook directly: {str(e)}"
        )
...
async def get_notebook_history(notebook_path: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get notebook history: {str(e)}"
        )
...
async def get_notebook_version(version_id: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get notebook version: {str(e)}"
        )


@router.get("/latest/{notebook_path:path}", status_code=200)
async def get_latest_version(
    notebook_path: str, branch_name: str = Query("main", description="ブランチ名")
):
    """
    最新バージョンを取得する
    ...
    """
    try:
        version = notebook_version_manager.get_latest_version(
            notebook_path, branch_name
        )
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get latest version: {str(e)}"
        )
...
async def get_notebook_snapshot(snapshot_id: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get notebook snapshot: {str(e)}"
        )
...
async def get_notebook_branch(branch_id: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get branch information: {str(e)}"
        )
...
async def get_version_system_stats():
    ...
    try:
        ...
        enhanced_stats = {
            **stats,
            "system_health": (
                "healthy" if stats.get("total_versions", 0) > 0 else "idle"
            ),
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get version system stats: {str(e)}"
        )
...
async def simulate_notebook_commit(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to simulate notebook commit: {str(e)}"
        )
...
async def reset_notebook_history(notebook_path: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to reset notebook history: {str(e)}"
        )
