...
def test_get_student_by_user_id(db_session: Session):
    ...
    retrieved_student = crud_student.get_student_by_user_id(
    ...
    # 存在しないユーザーを取得しようとする
    retrieved_student_none = crud_student.get_student_by_user_id(
        db=db_session, user_id="non_existent_user"
    )
