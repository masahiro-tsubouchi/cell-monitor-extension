...
class TestOfflineSyncQueue:
    ...
    def test_queue_events_success(self):
        ...
        with patch('api.endpoints.offline_sync.queue_event_for_offline_sync') as mock_queue:
...
class TestOfflineSyncStatus:
    ...
    def test_get_sync_status_success(self):
        ...
        with patch('api.endpoints.offline_sync.get_offline_queue_status') as mock_get_status:
...
class TestOfflineSyncTrigger:
    ...
    def test_trigger_sync_success(self):
        ...
        with patch('api.endpoints.offline_sync.get_offline_queue_status') as mock_status:
    ...
    def test_trigger_sync_force(self):
        ...
        with patch('api.endpoints.offline_sync.get_offline_queue_status') as mock_status, \
             patch('api.endpoints.offline_sync.sync_offline_events') as mock_sync:
            mock_status.return_value = {
                "sync_in_progress": False,
...
class TestOfflineSyncIntegration:
    ...
    def test_full_offline_sync_workflow(self):
        ...
        with patch('api.endpoints.offline_sync.queue_event_for_offline_sync') as mock_queue, \
             patch('api.endpoints.offline_sync.get_offline_queue_status') as mock_status, \
             patch('api.endpoints.offline_sync.sync_offline_events') as mock_sync:
